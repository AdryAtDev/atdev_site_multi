;(function () {
	...
	var app = {
		...
		headerSearchCloseNotEl: function (e) {
			if ($(e.originalEvent.target).closest('.header-search').length)
				return
		...
		headerNavbarNotEl: function (e) {
			if ($(e.originalEvent.target).closest('.header-navbar').length)
				return
		...
		clock: function (id, endtime) {
			...
			function updateClock() {
				...
				if (t.total <= 0) {
					...
					document.getElementById('deadline-message').className =
						'visible'
		...
		forms: function () {
			var ajaxurl = 'https://formspree.io/f/mwkwawqg'

			$.validator.addMethod(
				'customemail',
				function (value, element) {
					return /^(?:(?!(?:@gmail\.com|@outlook\.com|@hotmail\.com)).)*$/.test(
						value
					)
				},
			...
			$('.contact-forms').validate({
				rules: {
					...
					ServicesFormsRadioServiceStaff: {},
					ServicesFormsRadioServiceRecruiting: {},
					ServicesFormsRadioServiceCsd: {},
					ServicesFormsCheckboxNetcore: {},
					ServicesFormsCheckboxNetlegacy: {},
					ServicesFormsCheckboxAngular: {},
					ServicesFormsCheckboxNodejs: {},
					ServicesFormsCheckboxPython: {},
					ServicesFormsCheckboxReact: {},
					ServicesFormsCheckboxSalesforce: {},
					ServicesFormsCheckboxVuejs: {},
					ServicesFormsCheckboxAws: {},
					ServicesFormsCheckboxJava: {},
					ServicesFormsCheckboxOther: {},
					ServicesFormsPositionRadio: {},
				},
				messages: {
					ContactName: {
						required: 'The name field is required.',
...
function validateRecaptcha() {
	const emailValue = $("[name='ContactEmail']").val()
	const contactError = $('.contactEmailError')

	const notValidDomains = [
		'@gmail',
		'@yahoo',
		'@msn',
		'@hotmail',
	...
	for (const domain of notValidDomains) {
		if (emailValue.includes(domain)) {
			contactError.show()
			if (location.href.includes('/en/')) {
				contactError.text(`The domain: ${domain} is not valid.`)
			} else {
				contactError.text(`El dominio: ${domain} no es valido.`)
			}
			return false
		}
	}
